...
if ( !class_exists( 'avia_sc_image_nolightbox' ) )
{
	class avia_sc_image_nolightbox extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']			= __('Image sans Lightbox', 'avia_framework' );
				$this->config['tab']			= __('Media Elements', 'avia_framework' );
				$this->config['icon']			= AviaBuilder::$path['imagesURL']."sc-image.png";
				$this->config['order']			= 100;
				$this->config['target']			= 'avia-target-insert';
				$this->config['shortcode'] 		= 'av_image_nolightbox';
